...
function Trainers() {
  ...
  const [accountTrainer, setAccountTrainer] = useState(null)
  ...
  function openAccountForm(trainer) {
    setAccountTrainer(trainer)
    setAccountForm({ email: trainer.email || '', password: '' })
  }
  ...
  async function saveAccount(event) {
    ...
    setError('')
    try {
      await api.put(`/trainers/${accountTrainer._id}/account`, accountForm)
      setAccountTrainer(null)
      setAccountForm({ email: '', password: '' })
      await loadTrainers()
    } catch (requestError) { setError(requestError.response?.data?.message || 'Could not save trainer login.') }
