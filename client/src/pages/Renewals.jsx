...
function Renewals() {
  ...
  return <section className="page-stack">
    <div className="page-header"><div><p className="eyebrow">Membership desk</p><h1>Renewals</h1><p className="page-description">Track expired and upcoming membership end dates.</p></div><div className="member-total"><CalendarClock size={18} /> {renewals.length} due</div></div>
